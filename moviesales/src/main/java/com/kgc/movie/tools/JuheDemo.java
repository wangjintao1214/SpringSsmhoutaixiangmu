...
public class JuheDemo {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="f642767eb85fea0f959848e9180308bf";
    ...
    public static Object getRequest1(String title){
        ...
        try {
            ...
            object = JSONObject.parseObject(result);//字符串转json
    ...
    //5.今日放映影片
    public static void getRequest5(int cityId){
        String result =null;
